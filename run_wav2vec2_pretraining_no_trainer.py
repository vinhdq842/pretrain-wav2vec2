...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="The directories of the training data set splits to use (via the datasets library).",
    )
...
def main():
    ...
    datasets_splits = []
    for dataset_config_name, train_split_name, train_split_dir in zip(args.dataset_config_names, args.dataset_split_names,args.dataset_split_dirs):
        # load dataset
    ...
    print(f"  Num examples = {len(vectorized_datasets['train'])}")
